                    ...
                    <tbody>
                      ...
                      @foreach($OrdenProduccion as $OrdenProduccion)
                        <tr>
                                ...
                                <td>
                                 <a href="{{route('registro.mo',[$OrdenProduccion->id,$OrdenProduccion->ordenproduccion,$OrdenProduccion->centrocosto])}}" class="btn btn-primary">M.O.</a>
                              
                                @if($OrdenProduccion->aprobadaMO=='S')
